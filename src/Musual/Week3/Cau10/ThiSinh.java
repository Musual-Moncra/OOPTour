 ...
 *
 * <p>
 * Mỗi thí sinh có: họ tên, số báo danh (SBD), ba điểm thi,
 * và các cờ booleans cho học sinh giỏi và ưu tiên.
 * </p>
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>Sửa tất cả lỗi gán thiếu dấu '=' trong constructor và phương thức
 * nhap().</li>
 * <li>Sửa kiemTraDiemLiet(): dùng đúng phép so sánh (< 1.0) thay vì so sánh với
 * 0 sai kiểu.</li>
 * <li>Thêm toString() để in thông tin thí sinh một cách nhất quán, tránh lặp
 * code ở DanhSachTS.</li>
...
public class ThiSinh {
     ...
     *
     * <p>
     * Công thức: tổng 3 môn + 1.0 (nếu HS giỏi) + 0.5 (nếu ưu tiên).
     * </p>
     *
     ...
     *
     * <p>
     * <b>Sửa lỗi:</b> bản gốc dùng "== 0" trên double là không an toàn
     * (dấu phẩy động). Bản tối ưu dùng "< 1.0"
     * (quy tắc phổ biến: dưới 1.0 thì bị liệt).
     * </p>
     *
     ...
     *
     * <p>
     * <b>Lưu ý:</b> Gọi sc.nextLine() sau nextInt() để xả buffer,
     * tránh skip dòng tiếp theo.
     * </p>
     *
     ...
     *
     * <p>
     * <b>Tối ưu:</b> Tập trung logic định dạng vào đây thay vì
     * lặp lại string nối trong DanhSachTS.
     * </p>
     *
