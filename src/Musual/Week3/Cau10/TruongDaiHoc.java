 ...
 *
 * <p>Mỗi trường có tên và điểm chuẩn. Cung cấp phương thức xetTuyen()
 * để kiểm tra một thí sinh đơn lẻ.</p>
 *
 * <p><b>Tối ưu so với bản gốc:</b></p>
 * <ul>
 *   <li>Sửa lỗi gán thiếu dấu '=' trong constructor.</li>
 *   <li>Tách thông báo trúng/trượt rõ ràng, hiển thị thêm điểm chênh lệch khi trượt.</li>
...
public class TruongDaiHoc {
     ...
     *
     * <p>Điều kiện TRÚNG TUYỂN: điểm xét tuyển >= điểm chuẩn VÀ không có môn liệt.</p>
     * <p><b>Tối ưu:</b> In thêm điểm chênh lệch khi trượt để người dùng biết còn thiếu bao nhiêu.</p>
     *
